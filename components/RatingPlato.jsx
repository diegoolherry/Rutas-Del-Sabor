...
const RatingPlato = ({ id, name, setRefresh }) => {
        ...
        <div className="bg-white rounded-2xl border border-stone-100 shadow-sm p-6">
            <div className="space-y-4">
                <div>
                    ...
                    <p className="text-sm text-stone-400 mt-0.5">¿Qué te pareció este plato?</p>
                </div>
                ...
                {!enviado ? (
                    <div className="space-y-4">
                        ...
                        <div className="flex gap-1">
                            {[1,2,3,4,5].map((estrella) => (
                                ...
                                >
                                    <span
                                        style={{
                                            color: estrella <= (hover || rating) ? "#f50b0b" : "#d1d5db",
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full rounded-xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm text-stone-700 placeholder:text-stone-300 focus:outline-none focus:ring-2 focus:ring-red-400 resize-none transition"
                        />
                        ...
                        <button
                            ...
                            style={{
                                background: rating > 0
                                    ? "linear-gradient(135deg, #f50b0b, #ef4444)"
                                    : "#e5e7eb",
